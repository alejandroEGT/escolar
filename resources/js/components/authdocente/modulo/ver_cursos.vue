<template>
	<div class="animated fadeIn">
		<div class="">
			<h3>Mis Cursos</h3>
			<hr>
			<div class="card " style="width:20rem; margin-left: 4px; margin-top:4px; border:none; float:left; box-shadow: 5px 5px 25px #222 inset;box-shadow: 2px 2px 10px #666;        /* Sombra normal */
